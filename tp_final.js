...
texto [8]='Sin el apoyo de su esposo, Lydia, se cansa de intentar y decide dejar ser a los niños. Tal vez es como su marido dice y solo necesitan espacio. Peter y Wendy comienzan a separarse mas y mas de sus padres, viéndolos como no mas que unas maquinas expendedoras, mientrás se abstraen en su mundo africano';
...
text (texto [click], width / 2, height/ 2);
}else{
fill(200, 200, 0, 100);
